...
class Constant {
    ...
    static let ERROR_INVALID_PASSWORD = "Please enter valid password"
    static let ERROR_INVALID_USERNAME = "Please enter valid username"
    static let ERROR_EMPTY_PASSWORD = "Please enter password"
    static let ERROR_EMPTY_USERNAME = "Please enter username"
    ...
    static let LOGIN_VIEW_CONTROLLER_IDENTIFIER = "LoginViewController"
